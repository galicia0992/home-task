...
function convertUtiltiyToSXFromProps(componentProps, styledSystemProps, componentStyleConfig, reservedKeys = _styledSystem.reservedKeys, plugins = [], ignoreKeys = new Set(), Component = null, ExtendedConfig = {}) {
  ...
  if (plugins) {
    ...
    for (const pluginName in plugins) {
      ...
      // @ts-ignore
      [resolvedSxVerbose,,,, sxIgnoreKeys] = (_plugins$pluginName = plugins[pluginName]) === null || _plugins$pluginName === void 0 ? void 0 : _plugins$pluginName.inputMiddleWare(resolvedSxVerbose, true, false, Component, componentStyleConfig, ExtendedConfig);
    }
    ...
    componentStyleConfig.resolveProps.forEach(toBeResovledProp => {
      if (props[toBeResovledProp]) {
        ...
        if (CONFIG.propertyResolver && CONFIG.propertyResolver.props && CONFIG.propertyResolver.props[toBeResovledProp]) {
          ...
          let token = transformer(value, (value1, scale = aliasTokenType) => (0, _utils.resolveStringToken)(value1, CONFIG, CONFIG.propertyTokenMap, toBeResovledProp, scale));
          //@ts-ignore
...
function verboseStyled(Component, theme, componentStyleConfig = {}, ExtendedConfig, BUILD_TIME_PARAMS, nonVerbosedTheme) {
  var _componentStyleConfig, _Component3;
  ...
  function injectSx(sx, type = 'inline', inlineStyleMap, ignoreKeys = new Set()) {
    ...
    (0, _injectComponentAndDescendantStyles.injectComponentAndDescendantStyles)(orderedSXResolved, sxHash, type, _styleSheet.GluestackStyleSheet, _reactNative.Platform.OS, inlineStyleMap, ignoreKeys);
  ...
  const StyledComponent = ({
    ...
    if (!styleHashCreated) {
      ...
      if (plugins) {
        for (const pluginName in plugins) {
          var _plugins$pluginName2, _themeIgnoreKeys;
          let themeIgnoreKeys = new Set();
          // @ts-ignore
          [nonVerbosedTheme,,,, themeIgnoreKeys] = (_plugins$pluginName2 = plugins[pluginName]) === null || _plugins$pluginName2 === void 0 ? void 0 : _plugins$pluginName2.inputMiddleWare(nonVerbosedTheme, true, true, (componentProps === null || componentProps === void 0 ? void 0 : componentProps.as) ?? Component, componentStyleConfig, ExtendedConfig);
    ...
    inlineComponentPropsWithoutVariants, styledSystemProps, componentStyleConfig, reservedKeys, plugins, ignoreKeys, (inlineComponentPropsWithoutVariants === null || inlineComponentPropsWithoutVariants === void 0 ? void 0 : inlineComponentPropsWithoutVariants.as) ?? Component, ExtendedConfig);
    ...
    } = convertUtiltiyToSXFromProps(mergedPassingProps, styledSystemProps, componentStyleConfig, reservedKeys, plugins, ignoreKeys, (mergedPassingProps === null || mergedPassingProps === void 0 ? void 0 : mergedPassingProps.as) ?? Component, ExtendedConfig);
    ...
    if (containsSX) {
      ...
      if (Object.keys(applySxStatePassingProps.current).length > 0 || Object.keys(sxComponentPassingProps.current).length > 0) {
        ...
        } = convertUtiltiyToSXFromProps(passingPropsUpdated, styledSystemProps, componentStyleConfig, reservedKeys, plugins, ignoreKeys, (passingPropsUpdated === null || passingPropsUpdated === void 0 ? void 0 : passingPropsUpdated.as) ?? Component, ExtendedConfig);
    ...
    let AsComp = _react.default.useRef(resolvedStyleProps.as || passingProps.as || undefined).current;
    ...
    const ComponentWithPlugin = _react.default.useMemo(() => {
      if (plugins.length > 0) {
        var _Component;
        //@ts-ignore
        if (AsComp && !((_Component = Component) !== null && _Component !== void 0 && _Component.isStyledComponent)) {
          for (const pluginName in plugins) {
            var _plugins$pluginName3;
            // @ts-ignore
            if ((_plugins$pluginName3 = plugins[pluginName]) !== null && _plugins$pluginName3 !== void 0 && _plugins$pluginName3.componentMiddleWare) {
              var _plugins$pluginName4, _AsComp;
              // @ts-ignore
              AsComp = (_plugins$pluginName4 = plugins[pluginName]) === null || _plugins$pluginName4 === void 0 ? void 0 : _plugins$pluginName4.componentMiddleWare({
                Component: AsComp,
                theme,
                componentStyleConfig,
                ExtendedConfig,
          ...
          for (const pluginName in plugins) {
            ...
            if ((_plugins$pluginName5 = plugins[pluginName]) !== null && _plugins$pluginName5 !== void 0 && _plugins$pluginName5.componentMiddleWare) {
              var _plugins$pluginName6, _Component2;
              // @ts-ignore
              Component = (_plugins$pluginName6 = plugins[pluginName]) === null || _plugins$pluginName6 === void 0 ? void 0 : _plugins$pluginName6.componentMiddleWare({
                Component: Component,
                theme,
                componentStyleConfig,
                ExtendedConfig,
              ...
              pluginData = {
                ...pluginData,
                ...((_Component2 = Component) === null || _Component2 === void 0 ? void 0 : _Component2.styled)
              };
            }
          }
        }
  ...
  const displayName = componentStyleConfig !== null && componentStyleConfig !== void 0 && componentStyleConfig.componentName ? componentStyleConfig === null || componentStyleConfig === void 0 ? void 0 : componentStyleConfig.componentName : (_Component3 = Component) === null || _Component3 === void 0 ? void 0 : _Component3.displayName;
