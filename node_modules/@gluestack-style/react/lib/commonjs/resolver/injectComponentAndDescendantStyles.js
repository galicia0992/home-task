...
function injectComponentAndDescendantStyles(orderedResolved, styleTagId, type = 'boot', _GluestackStyleSheet = _styleSheet.GluestackStyleSheet, platform = '', inlineStyleMap, ignoreKeys = new Set()) {
  ...
  const toBeInjected = _styleSheet.GluestackStyleSheet.resolve(styleCSSIdsArr, {}, {}, false, type, ignoreKeys);
  if (platform === 'web') {
